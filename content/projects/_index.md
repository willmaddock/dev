...
- **JobTracker Hub** — Local-first Python/FastAPI and React dashboard that turns an existing job-search folder into a searchable Kanban pipeline, follow-up triage, macOS Mail.app email sync, document management, and application insights, with no cloud service or account required.
